    ...
    <div>
      <Container>
        <Topsection
          ...
          description={
            <p>
              About engineers gurukul <br /> We believe in excellence!
            </p>
          }
        />
      </Container>
      ...
      <Container className='about-info'>
        <div className='info-holder'>
          ...
          <div className='info'>
            <h4>ENGINEERS GURUKUL TRAINING CENTER</h4>
            <i>
              SD College Rd, Arjun Nagar, Besides Gurdwara Nanak, Jalandhar,
              Punjab 144001
            </i>
            <p>
        ...
        <div className='info-holder' style={styles}>
          <div className='info'>
            <h4>ENGINEERS GURUKUL SHOP</h4>
            <i>
              SBlock 13-206, Cabin 19, Division of Student Welfare, Lovely
              Professional University, Phagwara, Punjab 144411
            </i>
            <p>
              From its start, ENGINEERS GURUKUL has developed a visualization of
        ...
        <div className='info-holder'>
          ...
          <div className='info'>
            <h4>Our Trainers</h4>
            <p>
              At engineers Gurukul we have a team of highly skilled and
              experienced trainers to ensure the quality of the training. A team
              of highly experienced academicians and industry experts makes a
              perfect team of trainers, which is highly qualified and certified
              in their domains.
            </p>
            <p>
